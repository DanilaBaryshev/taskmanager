...
Веб-приложение для управления задачами в стиле Kanban с JWT-авторизацией, ролевой моделью доступа (RBAC) и обновлениями доски в реальном времени через WebSocket. Поддерживает совместную работу нескольких пользователей над одним проектом, историю изменений задач с возможностью отмены.
